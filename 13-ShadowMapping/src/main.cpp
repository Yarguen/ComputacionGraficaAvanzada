...
void applicationLoop() {
	...
	while (psi) {
		...
		//El primero paso es renderizar el buffer de profundidad
		glClearColor(0.1,0.1,0.1,1.0);
		glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
		//Render de la escena del punto de vista del observador
		...
		//Paso 2 renderizar los objetos desde la escena normal
		glViewport(0, 0, screenWidth, screenHeight);
		glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
		prepareScene();
